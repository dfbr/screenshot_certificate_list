    ...
    <div id="gallery-grid">
      <figure class="gallery-item">
        <a href="https://ilab.no" target="_blank" rel="noopener noreferrer">
          <img src="../2026-04-08_08-39-21/screenshots/ilab.no.png" alt="ilab.no" loading="lazy" />
          <figcaption>ilab.no</figcaption>
        </a>
      </figure>
      <figure class="gallery-item">
        <a href="https://www.ilab.no" target="_blank" rel="noopener noreferrer">
          <img src="../2026-04-08_08-39-21/screenshots/www.ilab.no.png" alt="www.ilab.no" loading="lazy" />
