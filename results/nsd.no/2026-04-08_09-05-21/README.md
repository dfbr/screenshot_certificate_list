# nsd.no — 2026-04-08_09-05-21

Certificates queried from [crt.sh](https://crt.sh/?q=%.nsd.no).
...
| `invitasjon.nsd.no` | ![invitasjon.nsd.no](screenshots/invitasjon.nsd.no.png) |
...
| `nsd.no` | ![nsd.no](screenshots/nsd.no.png) |
...
| `ess-search.nsd.no` | ![ess-search.nsd.no](screenshots/ess-search.nsd.no.png) |
...
| `admin.nsd.no` | ![admin.nsd.no](screenshots/admin.nsd.no.png) |
| `arkivering-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `studio.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `uptime.nsd.no` | ![uptime.nsd.no](screenshots/uptime.nsd.no.png) |
| `per-stage.nsd.no` | `HTTP 401` |
| `ess-test.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `minside-stage.nsd.no` | `HTTP 401` |
| `dmpoversikt.nsd.no` | ![dmpoversikt.nsd.no](screenshots/dmpoversikt.nsd.no.png) |
| `trd-mstgw1.nsd.no` | `timeout` |
| `www.nsd.no` | ![www.nsd.no](screenshots/www.nsd.no.png) |
| `ess-stage.nsd.no` | `HTTP 401` |
| `arkiveringsportalen.nsd.no` | ![arkiveringsportalen.nsd.no](screenshots/arkiveringsportalen.nsd.no.png) |
| `meldeskjema-stage.nsd.no` | `HTTP 401` |
| `redirect-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `minside.nsd.no` | ![minside.nsd.no](screenshots/minside.nsd.no.png) |
| `dataarkivering.nsd.no` | ![dataarkivering.nsd.no](screenshots/dataarkivering.nsd.no.png) |
...
| `eosc-provenance.nsd.no` | ![eosc-provenance.nsd.no](screenshots/eosc-provenance.nsd.no.png) |
| `institusjon.nsd.no` | ![institusjon.nsd.no](screenshots/institusjon.nsd.no.png) |
| `pvoportal.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `search.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `databestilling.nsd.no` | ![databestilling.nsd.no](screenshots/databestilling.nsd.no.png) |
| `search-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `search2.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `meldingsarkiv-stage.nsd.no` | `HTTP 401` |
| `arkivering.nsd.no` | ![arkivering.nsd.no](screenshots/arkivering.nsd.no.png) |
| `docs.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `invitasjon-stage.nsd.no` | `HTTP 401` |
| `meldeskjema.nsd.no` | ![meldeskjema.nsd.no](screenshots/meldeskjema.nsd.no.png) |
| `redirect.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `dataarkivering-stage.nsd.no` | `HTTP 401` |
| `ess-usage.nsd.no` | ![ess-usage.nsd.no](screenshots/ess-usage.nsd.no.png) |
| `fagskole.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `skolevalg.nsd.no` | ![skolevalg.nsd.no](screenshots/skolevalg.nsd.no.png) |
| `colectica-cloud-demo.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `search2-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `dus.nsd.no` | ![dus.nsd.no](screenshots/dus.nsd.no.png) |
| `per.nsd.no` | ![per.nsd.no](screenshots/per.nsd.no.png) |
| `lyncdiscover.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `surveybanken.nsd.no` | ![surveybanken.nsd.no](screenshots/surveybanken.nsd.no.png) |
| `norlag.nsd.no` | ![norlag.nsd.no](screenshots/norlag.nsd.no.png) |
| `meldingsarkiv.nsd.no` | ![meldingsarkiv.nsd.no](screenshots/meldingsarkiv.nsd.no.png) |
| `pilot-sso-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `o-stage.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `institusjon-stage.nsd.no` | `HTTP 401` |
| `signering.nsd.no` | ![signering.nsd.no](screenshots/signering.nsd.no.png) |
| `data-download-tracker.nsd.no` | ![data-download-tracker.nsd.no](screenshots/data-download-tracker.nsd.no.png) |
| `dmp-stage.nsd.no` | `HTTP 401` |
| `o.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `kibana.nsd.no` | `ERR_NAME_NOT_RESOLVED` |
| `ess.nsd.no` | ![ess.nsd.no](screenshots/ess.nsd.no.png) |
| `survey-sandbox-stage.nsd.no` | `HTTP 401` |
| `admin-stage.nsd.no` | `HTTP 401` |
| `ess-usage-stage.nsd.no` | `HTTP 401` |
| `www-stage.nsd.no` | `HTTP 401` |
| `dmp.nsd.no` | ![dmp.nsd.no](screenshots/dmp.nsd.no.png) |
